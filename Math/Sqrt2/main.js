...
function draw()
{
  if(Start)
  {
    ...
    if(SentenceNow == 2)
    {
      SentenceOne.html('1.' + Sentence[SentenceNow-2] + Sentence[SentenceNow-1]);
    }else if(SentenceNow == 3)
    {
      SentenceOne.html('1.' + Sentence[SentenceNow-3] + Sentence[SentenceNow-2] + Sentence[SentenceNow-1]);
    }else if(SentenceNow == 4)
    {
      SentenceOne.html('1.' + Sentence[SentenceNow-4] + Sentence[SentenceNow-3] + Sentence[SentenceNow-2] + Sentence[SentenceNow-1]);
    }else if(SentenceNow > 4)
    {
...
function buttonStart_Clicked()
{
  ...
  SentenceOne.html('1.' + Sentence[SentenceNow-1] + Sentence[SentenceNow]);
  SentenceTwo.html(' ');
